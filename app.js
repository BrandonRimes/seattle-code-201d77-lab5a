...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let arrString = `${sumArr} was passed in as an array of numbers, and ${arrSum} is their sum.`;
  return [arrSum, arrString];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  multArr.forEach(element => {
    arrPly = multiply(arrPly, element)[0];
  });
  let arrString = `The numbers ${multArr} have a product of ${arrPly}.`;
  return [arrPly, arrString];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  let arrString = `The numbers ${dynamicArray} have a product of ${arrPly}.`;
  return [arrPly, arrString];
}
